...
SKILL_META = {
    ...
    "description": (
        "该Skill处理新员工IT账号与基础设施相关查询，仅覆盖各系统的『接入层』信息："
        "【电脑配备】【笔记本/台式电脑申请】【有线/无线网络】【WiFi名称与密码】"
        "【系统账号开通与初始密码】（邮箱/OA/ERP/PLM/JIRA/CRM/FIS/HR等系统的账号本身、登录方式、访问地址、权限申请联系人）"
        "【IP查询】【信息安全规范】【受控区行为规范】【IT服务目录与联系人】等IT基础设施事务。"
        "⚠️不适用于这些系统承载的业务流程——例如『OA上的出差申请/报销审批/请假流程』、"
        "『HR系统里的考勤福利政策』、『ERP里的物料申请』等业务知识应路由到对应业务域Skill，"
        "本Skill只回答『某系统怎么登录/账号去哪申请』这类基础设施问题。"
    ),
